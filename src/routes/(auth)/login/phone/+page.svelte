        ...
        <div class="form bg-secondary h-full w-1/3  font-inter flex flex-col items-center justify-center">
            <form action="?/phone" method="POST" class="w-full px-16">
                ...
                <div class="mb-4">
                    ...
                    <input type="phone" name="phone" placeholder="+977 -" id="phone" class="bg-secondary border rounded-md placeholder-text-sm border-tertiary border-opacity-75 text-tertiary placeholder-tertiary placeholder-opacity-60 px-4 py-2 focus:border-primary placeholder:text-sm focus:outline-none focus:ring-1 focus:ring-primary w-full" required>
                </div>
